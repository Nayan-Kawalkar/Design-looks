...
/**
 * Point this at your transparent-background cutout, the same way your
 * Navbar references /src/assets/profile phto.jpg. Until you add the real
 * file, it falls back to a placeholder silhouette so nothing breaks.
 */
...
export default function JennySection() {
  ...
  return (
    ...
    >
      ...
      {/* Theme toggle */}
      <motion.div className="jh-toggle-row" variants={itemVariants}>
        <button
      ...
      {/* Hello badge */}
      <motion.div className="jh-badge-row" variants={itemVariants}>
        <span className="jh-badge">Hello!</span>
      </motion.div>

      {/* Headline */}
      <motion.h1 className="jh-headline" variants={itemVariants}>
        I&apos;m <span className="jh-accent">Jenny,</span>
      </motion.h1>
      <motion.h1
        className="jh-headline jh-headline-second"
      ...
      <div className="jh-content-row">
        {/* Left: quote + stat */}
        <motion.div className="jh-left-col" variants={itemVariants}>
        ...
        <motion.div className="jh-center-col" variants={photoVariants}>
        ...
        <motion.div className="jh-right-col" variants={itemVariants}>
